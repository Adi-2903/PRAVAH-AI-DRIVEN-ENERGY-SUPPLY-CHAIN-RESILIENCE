...
# Fix Windows console encoding — force UTF-8 output so emoji characters
# don't crash on cp1252 terminals.
...
def main():
    ...
    sources = {
        ...
        "OFAC (sanctions check)": lambda: check_entity_sanctions(KNOWN_SANCTIONED_ENTITY),
    }

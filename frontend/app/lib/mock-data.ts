...
export const CORRIDOR_RISK_DATA: CorridorRiskData[] = [
  ...
  },
  {
    ...
    confidence: 0.81,
    signals: [
      { type: 'geo_event', source: 'GDELT', weight: 0.4, detail: 'Routine traffic with minor delays at Port Said anchorage.' },
      { type: 'ais_anomaly', source: 'aisstream', weight: 0.3, detail: 'Normal AIS coverage — 97% of transiting vessels reporting.' },
      { type: 'price', source: 'EIA', weight: 0.2, detail: 'Canal transit fees stable; no surcharge applied.' },
      { type: 'sanctions', source: 'OFAC', weight: 0.1, detail: 'No sanctions-related activity detected.' },
    ],
    reasoning_trail: 'Suez Canal risk stable at 38.2/100. No significant geopolitical events, normal AIS coverage, and stable transit fees. Minor delays at Port Said anchorage are within seasonal norms.',
    as_of: minutesAgo(12),
  },
  {
  ...
  },
  {
    ...
    confidence: 0.92,
    signals: [
      { type: 'geo_event', source: 'GDELT', weight: 0.4, detail: 'Routine patrols by Malaysian and Singaporean navies. No incidents.' },
      { type: 'ais_anomaly', source: 'aisstream', weight: 0.3, detail: 'Normal traffic patterns. 99% AIS reporting compliance.' },
      { type: 'price', source: 'EIA', weight: 0.2, detail: 'Asian benchmark prices stable.' },
      { type: 'sanctions', source: 'OFAC', weight: 0.1, detail: 'No sanctions activity.' },
    ],
    reasoning_trail: 'Malacca Strait risk minimal at 14.8/100. All signals normal — routine naval patrols, near-perfect AIS compliance, stable pricing, no sanctions activity. This corridor is operating under baseline conditions.',
    as_of: minutesAgo(7),
  },
];

...
# Independent contract oracles (NOT api.py's own copies)
_shared_sim = _load("oracle_shared_simulate", "shared/schemas/simulate.py")
_spr_models = _load("oracle_spr_models", "spr-agent/models.py")
_proc_models = _load("oracle_proc_models", "procurement-agent/models.py")
